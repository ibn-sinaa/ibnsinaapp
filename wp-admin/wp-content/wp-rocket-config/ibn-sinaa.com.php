...
$rocket_cookie_hash = 'd3e84119dfae1b0551920cef67dfb2b8';
$rocket_logged_in_cookie = 'wordpress_logged_in_d3e84119dfae1b0551920cef67dfb2b8';
$rocket_cache_mobile_files_tablet = 'desktop';
$rocket_cache_reject_uri = '/(?:.+/)?feed(?:/(?:.+/?)?)?$|/(?:.+/)?embed/|/app/|/checkout/??(.*)|/cart/?|/(index.php/)?(.*)wp-json(/.*|$)';
