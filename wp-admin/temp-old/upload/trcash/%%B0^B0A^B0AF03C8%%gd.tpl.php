					...
					<!-- SPANNER -->
						...
						<table border="0" width="786" cellpadding="0">
							<tr>
								...
								<input type="radio" id="gduploadyes" value="1" name="gdupload" <?php if ($this->_tpl_vars['gd']['gd_upload'] == '1'): ?>checked<?php endif; ?> ><label for="gduploadyes">نعم</label></td>
								<td class="submain" width="273">
								<input type="radio" id="gduploadno" value="0" name="gdupload" <?php if ($this->_tpl_vars['gd']['gd_upload'] == '0'): ?>checked<?php endif; ?> ><label for="gduploadno"> لا</label></td>
							</tr>
							<tr>
								<td class="main" width="272">
								استخـــــدام التحقق عند الاتصال بالمـــــدير :</td>
								<td class="submain" width="233">
								<input type="radio" id="gdcontactyes" value="1" name="gdcontact" <?php if ($this->_tpl_vars['gd']['gd_admin'] == '1'): ?>checked<?php endif; ?> ><label for="gdcontactyes">نعم</label></td>
								<td class="submain" width="273">
								<input type="radio" id="gdcontactno" value="0" name="gdcontact" <?php if ($this->_tpl_vars['gd']['gd_admin'] == '0'): ?>checked<?php endif; ?> ><label for="gdcontactno"> لا</label></td>
							</tr>
							<tr>
								<td class="main" width="272">
								استخدام التحقق عند ارسال الصورة لصديق :</td>
								<td class="submain" width="233">
								<input type="radio" id="siteupload" value="1" name="gdfriend" <?php if ($this->_tpl_vars['gd']['gd_friend'] == '1'): ?>checked<?php endif; ?> >
								<label for="siteupload">نعم</label>
								</td>
								<td class="submain" width="273">
								<input type="radio" id="siteupload-no" value="0" name="gdfriend" <?php if ($this->_tpl_vars['gd']['gd_friend'] == '0'): ?>checked<?php endif; ?>>&nbsp;
							...
							<tr>
								...
								<td class="submain" width="233">
								<input type="radio" id="siteclose" value="1" name="gdreport" <?php if ($this->_tpl_vars['gd']['gd_report'] == '1'): ?>checked<?php endif; ?>> 
								<label for="siteclose">نعم</label>
								</td>
								<td class="submain" width="273">
								<input type="radio" id="siteclose-no" value="0" name="gdreport" <?php if ($this->_tpl_vars['gd']['gd_report'] == '0'): ?>checked<?php endif; ?>>&nbsp;
