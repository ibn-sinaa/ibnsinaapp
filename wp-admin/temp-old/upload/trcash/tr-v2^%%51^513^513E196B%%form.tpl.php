...
smarty_core_load_plugins(array('plugins' => array(array('function', 'allowext', 'form.tpl', 46, false),)), $this); ?>
...
<script language = "javascript" type = "text/javascript">
    ...
    var max_tr_upload = <?php echo $this->_tpl_vars['site']['site_maxinput']; ?>
;
</script>
...
/images/tr-up_28.gif" width="18" height="10"></td>
				...
				<div id="form">
				<?php echo $this->_tpl_vars['lang']['welcomemsg']; ?>
...
<form name = "tr_upload"   method = "post" enctype = "multipart/form-data" onsubmit="return check();"  action = "upload.php"  style = "margin: 0px; padding: 0px;">
	...
	<?php if ($this->_tpl_vars['site']['gd_upload'] == '1'): ?>
 
	<div id="captcha"><img src="captcha.php" border="0" alt="صورة التحقق">&nbsp;&nbsp; <input name="code" type="text" value=""></div>
	<?php endif; ?>
	<div align="center" >
	<strong><a target="_blank" href="page.php?page=extension"><?php echo $this->_tpl_vars['lang']['allowext']; ?>
</a>: </strong><?php echo allowext(array(), $this);?>
