...
/images/admin_08.gif">
					<p align="center"><span lang="ar-eg"><b>تعديل محتوي الصفحات</b></span><b>&nbsp;
					</b></td>
					<td width="2%">
					<img border="0" src="<?php echo $this->_tpl_vars['stylepath']; ?>
/images/admin_07.gif" width="22" height="31"></td>
				...
				<tr>
					...
					<div align="center">يمكنك اضافه اكواد html</div>
					
					<form name="" action="pages.php?do=<?php echo $this->_tpl_vars['do']; ?>
&go=update" method="post">
	
					<textarea rows="22" cols="77" name="page"><?php echo $this->_tpl_vars['pagecontents']; ?>
</textarea>
					<br>
					<input type="submit" value="تحديث الصفحة">	
					</form>
					</td>
				</tr>
			</table>
