...
<script type="text/javascript" src="js/mootools-1.2-core-yc.js"></script>
	...
	<script type="text/javascript" src="js/milkbox.js"></script>
	    ...
	    <style type="text/css">
		@import url({$stylepath}/milkbox/milkbox.css);
	</style>
...
height="10"></td>
				...
				<a href="{$files.imageurl}" rel="milkbox" title="{$files.file_name}">
				
				<img alt="" src="{$files.imagethumbs}" width="{$site.img_width}" height="{$site.img_high}" class="noborder">
				</a>
				
				<br>
				
				اضغط علي الصورة للتكبير<br>
				<br>
