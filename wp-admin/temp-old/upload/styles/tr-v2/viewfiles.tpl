...
var timer = {$site.site_second};
var msg_input = "{$lang.plswait}"
var this_url = "<a href ='{$files.file_url}' target='_blank'>{$lang.clickhear}</a>"
...
height="10"></td>
				...
				<img alt="" src="./extension/{$files.file_type}.gif" width="100" height="100" class="noborder">
