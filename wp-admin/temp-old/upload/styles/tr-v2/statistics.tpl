	...
	<tr>
		...
		<table style="width: 100%" cellspacing="0" cellpadding="0" dir="rtl">
			<tr>
				...
				<legend>احصائيات المركز </legend>
				<strong>عدد الصور : </strong>{$rank.totalpic}<br>
				<strong>عدد الملفات : </strong>{$rank.totalfiles}</fieldset>
				<br>
				<fieldset style="width: 444px">
				<legend>الاحصائيات العالمية</legend>
				 <strong>ترتيب اليكسا : </strong>{$rank.alexa}<br>
				ا<strong>لبيج رانك : </strong> 
				
				<img src="./images/pagerank/pr{$rank.pagerank}.gif" alt="10/{$rank.pagerank}" />&nbsp;&nbsp;[{$rank.pagerank}/10]
				</fieldset>
