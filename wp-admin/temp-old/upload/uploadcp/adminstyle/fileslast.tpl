...
<title>لوحة الادارة - الملفات منذ آخر زيارة</title>
</head>
		...
		<div align="center">
			<table border="0" width="89%" cellspacing="0" cellpadding="0">
				<tr>
					...
					<p align="center"><b>الملفات منذ آخر زيارة</b><b>&nbsp;
					</b></td>
					<td width="2%">
				...
				<tr>
					<td colspan="3" style="border: 1px solid #62607C" bgcolor="#EDF1F3">
						<div ><a href="files.php?do=fileslast&go=update">تجديد 
							آخر زيارة</a></div>
						...
						<table border="0" width="74%" cellpadding="0" cellspacing="4">
							<tr>
							{foreach name="file" from=$latfile item="file"}

								<td class="{$file.file_id}" bgcolor="#D9E1E6">
								<a target="_blank" href="{$file.file_url}">
								<img border="0" src="{lastfile filetype= $file.file_tybe}"  alt=""></a>
								<div>IP : {$file.ipaddress}</div>
								 
								<div>
								<a href="javascript: fileDelete({$file.file_id});">
			<img border="0" src="./images/delete.gif" alt="اضغط هنا للحذف" width="18" height="18"></a>
								</div>
								</td>
								
															
						     {if not $smarty.foreach.last and $smarty.foreach.file.iteration is div by 5}
